...
public class AssessmentTask extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assessment_task);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.assessment_task, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h= new Intent(AssessmentTask.this,Home.class);
                startActivity(h);
                break;
            case R.id.nav_lecture:
                Intent i= new Intent(AssessmentTask.this,Lecture.class);
                startActivity(i);
                break;
            case R.id.nav_assessment:
                Intent g= new Intent(AssessmentTask.this,AssessmentTask.class);
                startActivity(g);
                break;
